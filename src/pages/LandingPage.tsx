  ...
  return (
    <Layout>
      <Container>
        ...
        <h2 style={{
          margin: '2em 0 2em 0'
        }}>Dzięki nam szybko sprawdzisz:</h2>
        <FeaturesGrid>
          <Feature>
            ...
            <DoubleGrid>
              <SourcesAnimation>
                <div className="sources">
                  <i id="max-left" className="material-icons">cloud</i>
                  <i id="left" className="material-icons">business</i>
                  <i id="right" className="material-icons">map</i>
                  <i id="max-right" className="material-icons">globe</i>
