  ...
  <div className="mt-32 py-32 bg-primaryLight">
    <div className="w-narrowContainer mx-auto">
      ...
      <p className="mt-10 text-center text-lg">
        ...
        która skupia się na stosowaniu technologii do wzmocnienia i poprawy współpracy między obywatelami a administracją publiczną.
        Inicjatywy civic tech mają swoje źródło w konkretnych problemach społecznych dotyczących zwykłych ludzi,
        a najważniejszym celem jest nie sprzedaż rozwiązania, ale próba rozwiązania kwestii, które są problemem.
      </p>
    </div>
  </div>
);
