...
const DropdownWrapper = styled.div<{active: boolean}>`
    ...
    &:hover button{
        ...
        border-color: ${props => props.active ? props.theme.colors.primaryLight : 'transparent'};
    }
`;
                    ...
                    <ul>
                        {
                            props.choices.map((choice: Choice) => (
                                <ListItem
                                    ...
                                    key={choice.id}>{choice.label} <span className="material-icons">check</span></ListItem>
                            ))
                        }
                    </ul>
            </PerfectScrollbar>
